%% AA279D Control for Mode 4: Going to docking
% Tycho Bogdanowitsch
% Anshuk Chigullapalli 

function [delta_v_vals, delta_v_times] = mode4_control(roe_initial, roe_final, init_time, final_time, SV1_OE_init, u_SV1_init)
    ...
    %% Use two radial burns here. There is a feasible solution that works with just two burns here that could be really cool
    ...
    [delta_v_vals_inplane, delta_v_times_inplane] = radial_impulses_inplane(total_delta_roe(1), total_delta_roe(3:4), total_delta_roe(2), SV1_OE_init, u_SV1_init, init_time, final_time);
