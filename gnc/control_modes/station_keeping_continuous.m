function delta_v_vals_sk = station_keeping_continuous(SV_roe, SV_roe_nom, SV_delta_de_max, SV_delta_di_max, SV1_oe, N, k, n_orbits)
    ...
    if norm(SV_roe(3:4) - SV_roe_nom(3:4)) > SV_delta_de_max
        ...
        delta_v_vals_ecc = Lyapunov_feedback_control(SV_roe, SV_des_roe, SV1_oe, N, k, n_orbits);
    end
    ...
    if norm(SV_roe(5:6) - SV_roe_nom(5:6)) > SV_delta_di_max
        ...
        % perform station keeping 
        delta_v_vals_inc = Lyapunov_feedback_control(SV_roe, SV_des_roe, SV1_oe, N, k, n_orbits);
    end
