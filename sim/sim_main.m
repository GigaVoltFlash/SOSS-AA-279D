...
if run_PS3
    ...
    plot_3D_rel_orbit(SV2_rel_pos_ecc,SV3_rel_pos_ecc,true,'Non-linear method: 3D orbits','figures/PS3/ecc_nonlinear_3D_orbits.png')
    ...
    plot_3D_rel_orbit(SV2_YA_pos,SV3_YA_pos,true,'YA solution: 3D orbits','figures/PS3/YA_sol_3D_orbits.png')
    % 
    % % Geometric mapping
    ...
    plot_3D_rel_orbit(SV2_YA_mapping_pos,SV3_YA_mapping_pos,true,'Geometric mapping: 3D orbits','figures/PS3/YA_mapping_3D_orbits.png')
    % 
    % % Combined plots
    ...
    plot_RTN_error_vs_time(SV2_YA_pos,SV2_YA_mapping_pos,SV2_rel_pos_ecc,SV3_YA_pos,SV3_YA_mapping_pos,SV3_rel_pos_ecc,t_series,'figures/PS3/RTN_error_over_time_YA_comparison_SV2.png','figures/PS3/RTN_error_over_time_YA_comparison_SV3.png')
    ...
    plot_RTN_error_vs_time(SV2_YA_pos_2,SV2_YA_mapping_pos_2,SV2_rel_pos_ecc_2,SV3_YA_pos_2,SV3_YA_mapping_pos_2,SV3_rel_pos_ecc_2,t_series,'figures/PS3/RTN_error_over_time_YA_comparison_SV2_2.png','figures/PS3/RTN_error_over_time_YA_comparison_SV3_2.png')
    ...
    plot_RTN_error_vs_time(SV2_YA_pos_3,SV2_YA_mapping_pos_3,SV2_rel_pos_ecc_3,SV3_YA_pos_3,SV3_YA_mapping_pos_3,SV3_rel_pos_ecc_3,t_series,'figures/PS3/RTN_error_over_time_YA_comparison_SV2_3.png','figures/PS3/RTN_error_over_time_YA_comparison_SV3_3.png')
