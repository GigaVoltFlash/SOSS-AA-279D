...
state_SV2_init = [r_2_rtn_init; v_2_rtn_init];
...
[t_5, state5] = rk4_eom_ECI(tstart:tint:tend, state_SV2_init, false);
r_ECI_no_j2_SV2 = state5(:,1:3);
v_ECI_no_j2_SV2 = state5(:,4:6);

[rho_RTN_SV2, rho_dot_RTN_SV2] = ECI2RTN_rel(r_ECI_no_j2, v_ECI_no_j2, r_ECI_no_j2_SV2, v_ECI_no_j2_SV2);
...
if PS2_plots
    ...
    % plot_rel_sat_pos(SV2_rel_pos)
    plot_rel_sat_pos(rho_RTN_SV2)
end
