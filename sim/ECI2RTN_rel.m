function [rho_RTN, rho_RTN_dot] = ECI2RTN_rel(r_ECI_0, v_ECI_0, r_ECI_1, v_ECI_1)
    ...
    for i = 1:n
        ...
        omega0_rtn = Q * omega0_eci(i, :)';
        % rho_dot_corrected = (v_ECI_1(i,:) - v_ECI_0(i,:))' - cross(omega0_eci(i,:)', rho_ECI(i, :)');
        rho_RTN_dot(i, :) = Q * (v_ECI_1(i,:) - v_ECI_0(i,:))' - cross(omega0_rtn, rho_RTN(i, :)');
