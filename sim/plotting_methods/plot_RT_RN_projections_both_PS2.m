function plot_RT_RN_projections_both_PS2(SV2_rel_pos1, SV2_rel_pos2, SV3_rel_pos1, SV3_rel_pos2, title_string, fig_path)
    % Extract coordinates
    ...
    lgd = legend([p1, p2, p3, p4, p5], ...
        {'SV2 / Watcher with Relative EOM', 'SV2 / Watcher with FODE', ...
         'SV3 / Docker with Relative EOM', 'SV3 / Docker with FODE', 'SV1 / Chief'}, ...
